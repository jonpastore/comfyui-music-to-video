...
_stub("grok",
      ...
      list_models=lambda wait=True: ["grok-x", "grok-2"],
...
_stub("pipeline",
      ...
      gen_t2i=lambda model, slug, prompt, progress=None, n=1, size=1024, height=None, seed=None, style_lora="", style_lora_strength=1.0: [],
      fix_ref=lambda *a, **kw: [],
