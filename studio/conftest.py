...
_stub("pipeline",
      ...
      gen_anchor=lambda face, outfit, view="front", n=4, progress=None, prefix=None, profile=None, guard="", prompt="": anchor_calls.append({"profile": profile, "view": view, "guard": guard, "prompt": prompt}) or [],
