...
| **cerberus meowp-studio deploy** (`~/meowp-studio/app`, `meowp-studio.service`) | Grok — **released** | a0e0cd2 deployed from /tmp/deploytree. Queue was idle. Live song 3 needs Generate refs then approve new stills. | 2026-08-17 |
...
| **gamingpc ComfyUI** (`100.107.235.105:8188`) — matching nude pair, +20 skin, exposing | Grok — **released 2026-08-14** | pair_l20_out/: empty-latent pair failed (green front / plate-person back). latent=0.55 pair is her, lighter, matching, studio clean; tail still covers. Queue idle. | 2026-08-14 |
| **gamingpc ComfyUI** (`100.107.235.105:8188`) — identity-locked standing nude | Grok — **released 2026-08-14** | `identity_out/I_front_cfg2.0_st50_s129080599_uipair__gamingpc.png` in 185.2s. UI pair only. Queue idle. | 2026-08-14 |
| **gamingpc ComfyUI** (`100.107.235.105:8188`) — one charcoal-plate render, driven DIRECTLY | Grok — **released 2026-08-14** | done: `charcoal_out/C_back_cfg2.0_st50_s5151_charcoal__gamingpc.png` in 185.3s. Plate controls anatomy tone at seed 5151. Queue idle. | 2026-08-14 |
| **cerberus + gamingpc ComfyUI** (`:8188` on both) — anchor sweep, driven DIRECTLY, not through the studio queue | C — **STALE, superseded above.** four `anat2/` back-anatomy renders were in flight 2026-08-13 | `/tmp/.../scratchpad/anat2.py`. Left in the table so C can clear it if they return. | 14:36 |
