...
| P10 | A song for a child, and a G-tier video for it, is a first-class thing this studio can make | `T10-18` (built). `T10-18a` (built: `r` may mention in lyrics/narrative only). `T10-19a` (built: named-field list at the prompt boundary). `T10-18b`/`T10-19`/`T10-20`…`T10-26` still specification |
...
5. **TRD-10's minor policy.** `T10-18` is built: `g`/`pg13` may reference and
   ...
   an inverse of prompt fields. The rest of `T10-18b`/`T10-19`/`T10-20`…`T10-26`
