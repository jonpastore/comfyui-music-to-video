...
| **`T10-18`…`T10-26` the minor policy** | **partial** | this change | `T10-18` and `T10-18a` are built. `T10-18b`…`T10-26` (except the `T10-18c` floor constant) are still specification. `T10-19a` will inventory which form fields map to lyrics/narrative kinds |
