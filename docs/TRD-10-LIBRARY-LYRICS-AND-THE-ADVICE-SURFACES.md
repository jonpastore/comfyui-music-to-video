...
| **`T10-18`…`T10-26` the minor policy** | **partial** | this change | `T10-18`, `T10-18a`, `T10-18c`, `T10-19a` are built. `T10-18b`, `T10-19`, `T10-20`–`T10-26` remain specification / unlanded worktrees. `T10-10` (empty vs fetch-failed lyrics) is also still a worktree, not HEAD |
