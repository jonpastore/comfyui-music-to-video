...
| **`T10-18`…`T10-26` the minor policy** | **partial** | this change | `T10-18`, `T10-18a`, `T10-18b`, `T10-18c`, `T10-19a`, `T10-20`, `T10-24`, `T10-26` are built. `T10-19`, `T10-21`, `T10-22`, `T10-23`, `T10-25` remain specification / unlanded worktrees. `T10-10` (empty vs fetch-failed lyrics) is also still a worktree, not HEAD |
