...
| `T9-9`, `T9-12`, `T9-13c`, `T9-15` | **behaviour exists, no red checks on HEAD** | — | worktrees exist; closeout grind is landing these. `T9-11` / `T9-13a` / `T9-13b` already have checks |
