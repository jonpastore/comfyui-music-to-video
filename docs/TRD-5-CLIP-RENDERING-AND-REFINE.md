...
| `T5-5` peak VRAM of the shipped variant | **not measured** | — | the base render already peaks at 23.4 of 23.9 GB on cerberus; A's refine peak has not been read off the box |
