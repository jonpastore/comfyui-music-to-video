...
| **`T8-3`** a take records which path produced it | **partial** | `test_takes.py` | insert/origin CHECK exist. `h_audio` now writes origin on land |
...
| `T8-14`…`T8-15` predicted length / preview proxy | **not built** | — | deferred by TRD-1 §11 and claimed here |
