...
`test_t3_4_2_sat.py`; **`T3-4.2-black_frames` built** — partial black while mean PASSes FLAGs `black_frames`, `test_t3_4_2_black_frames.py`; **`T3-4.2-size_floor` built** — clip under `MIN_VIDEO_BYTES` REJECTs, `test_t3_4_2_size_floor.py`; **`T3-4.3-duration` built** — audio duration as requested within `DURATION_TOL_S`, `test_t3_4_3_duration.py`; **`T3-4.2-resolution` built** — clip `resolution`
