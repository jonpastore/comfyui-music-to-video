...
plate, picked from a thumbnail slider on the scene row — click opens a lightbox with search, a gallery grid, and a save icon; selecting a result pins it) → LTX 2.5 first → optional decoded s2v hop on lip scenes →
