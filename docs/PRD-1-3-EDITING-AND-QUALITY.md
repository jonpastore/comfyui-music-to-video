...
| P5 | Requested clip length is honoured end to end: `scene_seconds` in, a legal frame count out, the approve grid showing every clip, a re-plan leaving approved `(clip_idx, seed)` unchanged, and the planner prompt not naming a fixed 4.8125 s quantum | `T2-8`, `T2-12a`, `T2-13a`, `T2-13b`, `T2-13c`, `T2-14a` |
