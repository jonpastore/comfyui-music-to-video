...
| `studio/prompts.py` | 265 | TRD-2 §3.3 versioning; `restore(vid)` puts previous text back as a new version (`T2-5`); `running(vid)` is the row a render RUNS (`T3-20`) | built |
