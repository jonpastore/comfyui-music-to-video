...
| §4 remaining wands (`T2-14`…`T2-19`), `T2-25` meter remainder, §5.3 casting, `T2-27` scene refs | **not built** | — | |
...
| `T2-42`…`T2-46` per-scene model (W2) | **not built** | — | |
| §4 remaining wands (`T2-14`…`T2-19`), §5 meter, §5.3 casting | **not built** | — | |
| `T2-42`…`T2-44`, `T2-46` per-scene model (W2) | **not built** | — | |
...
| §4 wands (`T2-14`…`T2-16`, `T2-18`…`T2-22`), §5 meter, §5.3 casting | **not built** | — | |
