...
| `studio/pose_plan.py` | leftover unmapped image2 match; `plan` / `bind_scene` / `freeze_auto_binds` / `album_coverage`; `scene_actors` (partnered stance adds the album lead for Mage refs); no FastAPI. Not the T2-50 writer or the Accept-gated map |
