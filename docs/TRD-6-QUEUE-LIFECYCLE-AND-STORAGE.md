...
| `T6-A10` verification rule | **held** | this document | methodology leftover. T6-A10 is asserted wherever tests call the shared entry (`sets_service`, `storyboard_service`, `qc_service.listed`) |
