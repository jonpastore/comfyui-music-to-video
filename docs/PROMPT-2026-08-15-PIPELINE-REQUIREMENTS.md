...
| Docs TRD-2/3/4/5/7 + PRDs + DDDs + UIUX describe this loop | **rewritten 2026-08-17** — T2-50…T2-56, T3-34…T3-37, T4-21…T4-24, T5-11…T5-15, T7-21…T7-23. `T2-50`…`T2-56`, `T3-34`, `T4-21`…`T4-24`, `T5-11`, `T5-12` (graph), `T7-21`…`T7-23` **built**. Rest **not built** except where a pre-#529 check already covers a forbid (T5-15 latent, T3-28 no stranger swap). Leftover is T5-13…T5-15, D7 look `T3-37` |
