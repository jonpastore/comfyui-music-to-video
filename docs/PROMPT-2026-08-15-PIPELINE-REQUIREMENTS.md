...
| Docs TRD-2/3/4/5/7 + PRDs + DDDs + UIUX describe this loop | **rewritten 2026-08-17** — T2-50…T2-56, T3-34…T3-37, T4-21…T4-24, T5-11…T5-15, T7-21…T7-23. `T2-50`, `T2-51`, `T2-52`, `T2-53`, `T2-56`, `T4-21`/`T4-22`, `T4-23`, `T4-24`, `T7-21`, `T7-22`, `T7-23` **built**. Rest **not built** except where a pre-#529 check already covers a forbid (T5-15 latent, T3-28 no stranger swap). Code leftover is T2-54…T2-55, LTX-first, D7 |
