...
| **tier 3, §6 entire** | **partial** | `test_qc_approve.py` | `approve()` enqueues one repair and a dest ≠ source (`T3-6`/`T3-18`). `T3-20`, `T3-22`, `T3-23`, `T3-24` and `T3-25` are their own rows. Remaining in §6: T3-19, T3-21, T3-26…T3-28 |
